        ...
        >
          ...
          >
            <div className="flex flex-col space-y-6 max-w-full md:max-w-xl text-center md:text-left ">
              ...
              <NavLink to={"/products"}><button className="bg-gradient-to-r from-pink-500 to-purple-500 text-white p-2 rounded-lg w-[100px] focus:ring-2 focus:ring-purple-500">
                Shop Now
              </button></NavLink>
            </div>
