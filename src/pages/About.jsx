...
//   return (
//     <div>
//       <div className="flex flex-col ml-[150px] mr-[150px]">
//         <div className="grid grid-cols-2 pt-[90px] ">
//           <div>
//             <img
...
//               About <span className="text-pink-600 text-5xl">L</span>uxora
//             </i>
//             <p>
...
//               satisfying.
//             </p>
//             <p className="text-xl font-bold text-pink-700" >Why Choose Luxora?</p>
//             <ul className="ml-4">
...
//                 <h1 className="font-bold text-2xl text-pink-700">Our Mission</h1>
//                 <p>To create an inspiring and stress-free shopping environment where customers can discover products they love, at prices they trust.</p>
//                 <img src="/media/image/about.avif"  />
//             </div>
//             <div className="space-y-4 w-[500px]">
//                 <h1 className="font-bold text-2xl text-pink-700">Our Vision</h1>
//                 <p>To become one of India’s most beloved and customer-centric e-commerce brands, empowering every shopper with choice, confidence, and convenience.</p>
//                 <img src="/media/image/about1.avif" alt="" />
//             </div>
